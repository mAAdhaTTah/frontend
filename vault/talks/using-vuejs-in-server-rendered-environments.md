...
tags:
  - talk
  - web
slug: talks/using-vuejs-in-server-rendered-environments
title: Using Vue.js in Server Rendered Environments
description: If you can't server-side render with Node, Vue can be a solid option, providing the relevant SEO content on page load while enabling component-based interactivity.
published_at: 2017-11-20T17:58:28.000Z
updated_at: 2017-11-20T17:58:28.000Z
share: true
---
...
## Vue.js is actually quite good for this.
...
<div id="app">
  ...
  <blog-post-list>
    <blog-post url="http://myblog.com/my-post-1/">
      ...
      <img
        src="http://myblog.com/image-1.jpg"
        alt="Feature image"
        slot="image"
      />
    ...
    <blog-post url="http://myblog.com/my-post-2/">
      ...
      <img
        src="http://myblog.com/image-2.jpg"
        alt="Feature image"
        slot="image"
      />
      <p slot="summary">A summary of the blog post.</p>
...
```html
<tab-container id="a">
  <tab-header slot="header" id="0"> Tab 1 </tab-header>
  <tab-content slot="content" id="0"> Tab 1 content </tab-content>
  <tab-header slot="header" id="1"> Tab 2 </tab-header>
  <tab-content slot="content" id="1"> Tab 2 content </tab-content>
</tab-container>
```
