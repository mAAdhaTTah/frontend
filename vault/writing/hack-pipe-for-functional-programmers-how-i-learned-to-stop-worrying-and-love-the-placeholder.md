...
We don't even need functional versions of these operators! We can compose _operators_, not just functions, without needing to introduce or write a whole library for them.
