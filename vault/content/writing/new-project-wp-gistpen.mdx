...
description: |
  Where I hosted my data online used to not really be an issue for me; in fact, for a long time, I really wanted to get as much of my online “stuff” (documents, contacts, calendar, email, etc.) in a single location1. Since the NSA revelations we’ve all heard about, we know for a fact that \[…]
slug: writing/new-project-wp-gistpen
published_at: 2014-07-27T14:55:46.000Z
updated_at: 2014-07-28T13:40:08.000Z
status: publish
---
...
That's the inspiration behind [WP-Gistpen](https://jamesdigioia.com/wp-gistpen/).

I'm looking to replicate [Gist's](https://gist.github.com/) functionality with embeddable code snippets.[^2] Integrating the Gistpen's creation process into your writing process will make it easier to write blog posts with code snippets instead bouncing between multiple sites.
...
[Check it out](http://wordpress.org/plugins/wp-gistpen/) and let me know what you think of it.
