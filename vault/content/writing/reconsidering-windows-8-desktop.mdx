...
slug: writing/reconsidering-windows-8-desktop
published_at: 2012-11-27T18:32:17.000Z
updated_at: 2014-09-27T19:15:56.000Z
status: publish
---
...
Obviously, we're not there yet -- the Surface, which kind of fits the tablet/laptop combo mold (except it runs a different processor and won't run 'legacy' Windows programs, despite the presence of "Desktop"), [has been pretty universally panned so far](http://gigaom.com/mobile/microsoft-surface-reviews-come-for-the-hardware-tolerate-the-software/ "Microsoft Surface reviews: come for the hardware, tolerate the software") (owing mostly to the awful Windows RT), and many of the laptops being produced don't really handle this touchscreen/laptop interface all that well. But I do think I have to reconsider the possibilities now that we have a "touchscreen-enabled OS" in Windows 8.
