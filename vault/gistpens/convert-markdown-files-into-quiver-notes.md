...
tags:
  - web
  - snippet
title: Convert Markdown Files into Quiver Notes
description: ""
slug: gistpens/convert-markdown-files-into-quiver-notes
published_at: 2015-12-22T00:15:19.000Z
updated_at: 2015-12-22T00:15:19.000Z
share: true
---
...
function generateQuiverNote(filename) {
  ...
  return createNoteDir().then(() =>
    Bluebird.join(createNoteMeta(), createNoteContent()),
  );
