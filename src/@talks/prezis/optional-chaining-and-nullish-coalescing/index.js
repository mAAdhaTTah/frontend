  ...
  return (
    <Deck transitionDuration={500} theme={DarkTheme} transition={['slide']}>
      ...
      <Slide>
        ...
        <Text>
          Optional Chaining allows a developer to handle many cases of nested,
          potentially nullish values.
        </Text>
        <Appear>
          <Text>
      ...
      <Slide>
        ...
        <Text>
          Nullish Coalescing allows a developer to provide a default value for
          potentially nullish values.
        </Text>
        <Appear>
          <Text>
      ...
      <Slide>
        <Text>
          These two features were tied together to enable developers to access
          deeply nested properties and provide reliable fallbacks if they're not
          available.
        </Text>
      </Slide>
      <Slide>
      ...
      <Slide>
        ...
        <UnorderedList>
          ...
          <ListItem>
            <strong>DON'T</strong>: Use Optional Chaining on every access "for
            protection".
          </ListItem>
          <ListItem>
            <strong>DO</strong>: Use Nullish Coalescing when falsey values
            should be retained.
          </ListItem>
          <ListItem>
      ...
      <Slide>
        <Heading
          ...
          margin={'1em 0'}
        >
          DON'T: Expect Nullish Coalescing to provide defaults for empty strings
          and 0.
        </Heading>
