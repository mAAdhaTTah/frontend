...
export default () => (
  <Deck transition={['slide']} transitionDuration={500} theme={DarkTheme}>
    ...
    <Slide>
      <Heading size={3} fit margin={'30px 0'}>
    ...
    <Slide>
      <CodePane
        ...
        textSize={'2rem'}
        source={takeUntilBy}
        style={{ maxWidth: '500px', paddingBottom: '20p' }}
      />
      <Text textSize={'2rem'} margin={'20px 0'}>
    ...
    <Slide>
      <Text bold margin={'40px'}>
        Interested in exploring further?
      </Text>
      <Text textAlign={'left'}>
        kefir:{' '}
        <Link href={'https://github.com/kefirjs/kefir'}>
          github.com/kefirjs/kefir/
        </Link>
      </Text>
      <Text textAlign={'left'}>
        brookjs:{' '}
        <Link href={'https://github.com/valtech-nyc/brookjs/'}>
          github.com/valtech-nyc/brookjs/
        </Link>
      </Text>
    </Slide>
    {ThankYou()}
