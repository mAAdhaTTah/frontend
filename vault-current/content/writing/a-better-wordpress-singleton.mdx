...
!\[\[A Better WordPress Singleton#^normal-singleton-and-boot-php]]
...
!\[\[A Better WordPress Singleton#^improved-singleton-php]]
...
!\[\[A Better WordPress Singleton#^improved-boot-php]]
