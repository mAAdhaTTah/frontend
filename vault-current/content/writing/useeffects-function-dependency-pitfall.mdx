...
!\[\[useEffect dependency array issues#^useEffect-issue-js]]
...
!\[\[useEffect dependency array issues#^refreshCart-js]]

Then we can wrap the function in `useCallback` like this:

!\[\[useEffect dependency array issues#^refreshCart-useCallback-js]]
...
!\[\[useEffect dependency array issues#^refreshCartRef-js]]
...
!\[\[useEffect dependency array issues#^refreshCart-eslint-disable-js]]
